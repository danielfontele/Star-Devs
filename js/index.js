...
const startships = document.getElementById('starships');
...
function fillCounters() {
    Promise.all([
        ...
        .then(data => {
            ...
            startships.style.fontSize = '5em';
            planets.style.fontSize = '5em';

            persons.innerHTML = data[0].count;
            startships.innerHTML = data[1].count;
...
function loadPhrase() {
    const btn = document.getElementById('btn_phrases');
